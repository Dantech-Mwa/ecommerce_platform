...
def main():
    ...
    col1.metric("Total Revenue/100000", f"Ksh {int(metrics['total_revenue']/100000):.2f,}")
    col2.metric("Avg Order Value/100000", f"Ksh {int(metrics['avg_order_value']/100000):.2f,}")
